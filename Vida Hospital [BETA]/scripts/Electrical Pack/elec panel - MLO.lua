...
function tick()
    ...
    if GetPlayerInteractShape() == bkr1 and InputPressed("interact") and power and not broken then
        if on1 then
            on1 = false
            PlaySound(offSound)
    ...
    if GetPlayerInteractShape() == bkr2 and InputPressed("interact") and power and not broken then
        if on2 then
            on2 = false
            PlaySound(offSound)
    ...
    if GetPlayerInteractShape() == bkr3 and InputPressed("interact") and power and not broken then
        if on3 then
            on3 = false
            PlaySound(offSound)
    ...
    if GetPlayerInteractShape() == bkr4 and InputPressed("interact") and power and not broken then
        if on4 then
            on4 = false
            PlaySound(offSound)
    ...
    if GetPlayerInteractShape() == bkr5 and InputPressed("interact") and power and not broken then
        if on5 then
            on5 = false
            PlaySound(offSound)
    ...
    if GetPlayerInteractShape() == bkr6 and InputPressed("interact") and power and not broken then
        if on6 then
            on6 = false
            PlaySound(offSound)
    ...
    if GetPlayerInteractShape() == bkr7 and InputPressed("interact") and power and not broken then
        if on7 then
            on7 = false
            PlaySound(offSound)
    ...
    if GetPlayerInteractShape() == bkr8 and InputPressed("interact") and power and not broken then
        if on8 then
            on8 = false
            PlaySound(offSound)
    ...
    if GetPlayerInteractShape() == bkr9 and InputPressed("interact") and power and not broken then
        if on9 then
            on9 = false
            PlaySound(offSound)
    ...
    if GetPlayerInteractShape() == bkr10 and InputPressed("interact") and power and not broken then
        if on10 then
            on10 = false
            PlaySound(offSound)
    ...
    if GetPlayerInteractShape() == bkr11 and InputPressed("interact") and power and not broken then
        if on11 then
            on11 = false
            PlaySound(offSound)
    ...
    if GetPlayerInteractShape() == bkr12 and InputPressed("interact") and power and not broken then
        if on12 then
            on12 = false
            PlaySound(offSound)
